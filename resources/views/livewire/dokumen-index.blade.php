                ...
                <div class="flex flex-col md:flex-row gap-6 items-start md:items-center">
                    ...
                    <div class="flex-shrink-0 mt-4 md:mt-0 w-full md:w-auto">
                        <button wire:click="download({{ $dokumen->id }})"
                            class="w-full md:w-auto inline-flex justify-center items-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm shadow-blue-200 dark:shadow-none">

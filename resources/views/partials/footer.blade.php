        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-2">
                <a href="{{ url('/') }}" class="inline-block mb-4">
                    <span class="text-xl font-bold text-gray-900">{{ $pengaturan->name ?? config('app.name') }}</span>
                </a>
            ...
            <!-- Quick Links -->
            <div>
                <h4 class="text-lg font-semibold text-gray-900 mb-4">Tautan Cepat</h4>
                <ul class="space-y-2">
                    <li><a href="{{ url('/') }}" class="text-gray-600 hover:text-blue-600 transition-colors">Beranda</a></li>
